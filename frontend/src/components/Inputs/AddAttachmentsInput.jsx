...
const AddAttachmentsInput = ({ attachments, setAttachments }) => {
  ...
  // Function to handle adding an option (attachment link)
  ...
  const handleDeleteOption = (indexToDelete) => {
    const updatedArr = attachments.filter((_, idx) => idx !== indexToDelete);
    setAttachments(updatedArr);
  };

  return (
    <div>
      {/* Mapped List of Attachments */}
      ...
      <div className="flex items-center gap-5 mt--4">
        <div className="flex-1 flex items-center gap-3 border border-gray-100 rounded-md px-3 ">
          ...
          <input
            ...
            className="w-gull text-[13px] text-black outline-none bg-white py-2"
          />
        </div>
